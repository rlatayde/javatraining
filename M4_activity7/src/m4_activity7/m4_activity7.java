...
public class m4_activity7 {
    ...
    static class BankAccount {
        ...
        private static final Logger logger = LoggerFactory.getLogger(m4_activity7.class);
    ...
    // App-level logger
    private static final Logger log = LoggerFactory.getLogger(m4_activity7.class);
